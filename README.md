...
Find the directory with your language (add it if it does not exist). Then add your regex program. Please keep the directories and file naming schemes consistent with what is already in the repo.
